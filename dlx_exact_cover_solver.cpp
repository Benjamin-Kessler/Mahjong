/**
 * @file dlx_exact_cover_solver.cpp
...
/**
 * @brief Main function for testing the DLX::exact_cover_solver class.
...
int main()
{
    ...
    std::vector<std::set<int>> solutions = ecs.find_exact_covers(sets);

    for (std::set<int> set : solutions)
    {
        for (int value : set)
            std::cout << value << " ";
        std::cout << "\n";
